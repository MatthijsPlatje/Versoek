<?PHP
    ...
    {
        $result = $fgmembersite->RemoveFromTODO();
    ...
    <body>
        ...
        <div class="container">
            <div class="launch_info">
                <h2 style="color: #7448b1; font-size: 40px; text-align: center; margin-top: 0px; margin-bottom: 0px;">ToDo cancellen</h2><hr>
                ...
                <form action='<?php echo $fgmembersite->GetSelfScript(); ?>' method='post' accept-charset='UTF-8'>
                        ...
                        <h2 style="text-align: center;">wil cancellen?</h2>

                        <script>
                            var url_string = window.location.href;
                            var url = new URL(url_string);

                            var contact_name = url.searchParams.get("request_contact");
