    ...
    <body>
        ...
        <div class="container">
            <div class="launch_info">
                ...
                <button style="margin-left: 20px;" onclick="window.location.href='platform/my_history.php';" class="button_back">Terug</button>
                ...
                <div class="contact_form">
                    <form action="action_page.php">
                        ...
                        <table style="margin-left: 0%; width: 100%;">
                            <tr>
                                <td style="background-color: rgb(61, 204, 209); border: 1px solid black; border-radius: 10px;"><h2 style="background-color: rgb(61, 204, 209); margin: 8px;">Voor:</h2></td>
                                <td style="border: 1px solid black; border-radius: 10px;"><h2 style="text-align: right; margin: 8px;" id="name"></h2></td>
                            </tr>
                            <tr>
                        ...
                        <script>
                            ...
                            var item_name = url.searchParams.get("contact_name");
                            if(item_name == "me") item_name = "mijzelf";
                            if(item_name) document.getElementById("name").innerHTML = item_name;
                            ...
                            var status_text = (item_status == 0 ? "Is gecancelled" : (item_status == 2 ? "Is voltooid" : ""));
                            if(item_status == 1) document.getElementById("div_for_status").innerHTML = '<td colspan="2" style="background-color: rgb(61, 244, 90); border: 1px solid black; border-radius: 10px;"><h2 style="text-align: right; margin: 8px;" id="item_status">' + status_text + '</h2></td>;'
                        </script>
