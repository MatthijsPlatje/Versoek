    ...
    <body>
        ...
        <div class="container">
            <div class="launch_info">
                <h2 style="color: #7448b1; font-size: 40px; text-align: center; margin-top: 0px; margin-bottom: 0px;">Nog te doen</h2><hr>
                
                <button style="margin-left: 20px" onclick="window.location.href='platform/start.php';" class="button_back">Terug</button>

                <table>
                    <?php
                        $query = $fgmembersite->GetMyTODO();
